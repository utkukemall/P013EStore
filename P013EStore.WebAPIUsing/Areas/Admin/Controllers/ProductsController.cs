...
namespace P013EStore.WebAPIUsing.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        private readonly string _apiAdresCategory = "https://localhost:7032/api/Categories";
        private readonly string _apiAdresBrand = "https://localhost:7032/api/Brands";
        ...
        {
            ViewBag.ParentId = new SelectList(await _httpClient.GetFromJsonAsync<List<Product>>(_apiAdres), "Id", "Name");
            ViewBag.CategoryId = new SelectList(await _httpClient.GetFromJsonAsync<List<Category>>(_apiAdresCategory), "Id", "Name");
            ViewBag.BrandId = new SelectList(await _httpClient.GetFromJsonAsync<List<Brand>>(_apiAdresBrand), "Id", "Name");
            return View();
        }
